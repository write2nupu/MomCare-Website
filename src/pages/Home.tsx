...
import HeroImageHome from "../assets/images/HeroImageHome.png";
        ...
        <div className="min-h-screen flex flex-col bg-white overflow-hidden">
            ...
            <section className="relative min-h-[90vh] md:min-h-screen overflow-hidden">
                ...
                <div
                    ...
                    style={{ backgroundImage: `url(${HeroImageHome})` }}
                />
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-start">
                  ...
                  ${isOpen
                                ...
                                >
                                    ...
                                    >
                                        <span
                                            className={`text-lg font-semibold ${isOpen ? "text-primary" : "text-gray-900"
                                                }`}
                                        >
                                            {faq.question}
                                        </span>
