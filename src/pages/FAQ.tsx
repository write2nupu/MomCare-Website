...
import HeroImageFAQ from "../assets/images/HeroImageFAQ.jpg"
        ...
        <div className="min-h-screen flex flex-col bg-white overflow-x-hidden">
            ...
            <section className="relative pt-28 sm:pt-32 md:pt-40 pb-16 sm:pb-20 md:pb-28 overflow-hidden">
                ...
                <div
                    ...
                    style={{ backgroundImage: `url(${HeroImageFAQ})` }}
                />
                  ...
                  ${isOpen
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span
                                            className={`text-base sm:text-lg font-semibold ${isOpen ? "text-primary" : "text-gray-900"
                                                }`}
                                        >
                                            {faq.question}
                                        </span>
